...
**EduQuest では、すべてのクエストタイプ（MathQuest、ClockQuest、KokugoQuest、GameQuest）でボタン式の解答入力を採用しています。**
...
**KokugoQuest と同様に、すべての Quest で学年を最初に選択してから他のステージオプションを決める画面フローを共通化します。**
...
KokugoQuest は既にこのパターンで実装されており、MathQuest / ClockQuest も同じ学年先行構成に合わせることで UX の統一性を保ちます。
