...
| --- | --- |
| 見出し | 🪪 **オープンで誠実な運営** |
| コンテンツ | ・開発運営：*EduQuest Project*<br>・リードエンジニア：[tqer39](https://github.com/tqer39)（教育系SRE）<br>・ソースコード：[GitHub Repository](https://github.com/tqer39/edu-quest)<br>・プライバシーポリシー：`/privacy`（公開予定）<br>・お問い合わせ：`contact@eduquest.app` |
